...
const HomeCTA = ({ onApplyClick }: HomeCTAProps) => {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 md:py-40 bg-[#060d14] overflow-hidden">
      {/* Lime glow orb */}
      ...
      <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
        <div ref={contentRef}>
          ...
          <h2 className="text-4xl md:text-7xl lg:text-[10rem] font-black text-white uppercase tracking-tighter leading-[0.85] mb-8 md:mb-10">
            LET'S <span className="text-lime">MOVE</span><br />YOUR FREIGHT.
          </h2>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12 md:mb-16">
