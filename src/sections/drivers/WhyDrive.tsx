...
const WhyDrive = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      id="why-choose"
      className="relative py-24 md:py-32 bg-navy-dark overflow-hidden"
    >
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-lime/5 rounded-full blur-[120px] -mr-[25vw] -mt-[25vw]" />
      <div className="absolute bottom-0 left-0 w-[30vw] h-[30vw] bg-navy-light rounded-full blur-[100px] -ml-[15vw] -mb-[15vw]" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          {reasons.map((reason, idx) => (
            ...
            >
              <div className="glass-card h-full p-8 md:p-10 border-white/5 group-hover:border-lime/40 transition-all duration-500 flex flex-col items-start gap-6 overflow-hidden">
                {/* Hover accent */}
                ...
                <div className={`p-4 bg-navy border border-white/10 ${reason.color === 'lime' ? 'text-lime' : 'text-white'} group-hover:bg-lime group-hover:text-navy transition-all duration-500 transform group-hover:rotate-12`}>
                  <reason.icon className="w-8 h-8" />
                </div>

                <div className="relative z-10">
                  <h3 className="text-2xl font-black text-white mb-4 uppercase tracking-tight group-hover:text-lime transition-colors">
                    {reason.title}
                  </h3>
                  <p className="text-gray-400 text-lg leading-relaxed group-hover:text-white/90 transition-colors">
                    {reason.desc}
                  </p>
                </div>
